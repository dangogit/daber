...
const AccessibilityOnboarding: React.FC<AccessibilityOnboardingProps> = ({
  ...
  if (isChecking) {
    return (
      <div className="titlebar-inset h-screen w-screen flex items-center justify-center">
  ...
  if (allGranted) {
    return (
      <div className="titlebar-inset h-screen w-screen flex flex-col items-center justify-center gap-4">
  ...
  return (
    <div className="titlebar-inset h-screen w-screen flex flex-col p-6 gap-6 items-center justify-center">
